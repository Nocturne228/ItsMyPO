...
var T = {
    zh: {
        ...
        "deleteMode.single": "删除单页",
        "deleteMode.range": "删除前 / 后 N 页",
        "deleteMode.range-se": "删除指定页码范围",
        "deleteCount.label": "页码 / 页数",
        "deleteStart.label": "起始页",
        "deleteEnd.label": "结束页",
        "deleteBack.label": "从后往前数",
        "deleteBtn": "执行删除",
        // Extract
        "panel-extract.h3": "页面提取",
        "extractMode.label": "提取模式",
        "extractMode.png": "单页 → PNG",
        "extractMode.pdf": "页码范围 → PDF",
        "extractDpi.label": "DPI 模式",
        "extractDpi.bw": "黑白 (600 DPI)",
        "extractDpi.color": "彩色 (300 DPI)",
        ...
        "zipDpi.label": "DPI 模式",
        "zipDpi.bw": "黑白 (600 DPI)",
        "zipDpi.color": "彩色 (300 DPI)",
        "zip2pdfBtn": "执行转换",
        // Clean
        "panel-clean.h3": "清理",
        "cleanType.label": "清理类型",
        "cleanType.x_backup": "x_backup（缩放备份）",
        "cleanType.y_backup": "y_backup（页面处理备份）",
        "cleanType.zip": "ZIP 压缩文件",
        "cleanType.all": "全部清理",
        "cleanBtn": "执行清理",
        // Image tabs
        ...
        "imageMergeMode.vertical": "上下相接长条",
        "imageMergeMode.horizontal": "左右拼接长条",
        ...
        "imageConvertScope.selected": "当前选中图片",
        "imageConvertScope.all": "当前目录全部图片",
        "imageConvertFormat.label": "目标格式",
        "imageConvertBtn": "执行格式转换",
        // Image compress
        "image-panel-compress.h3": "大小压缩",
        "imageCompressScope.label": "处理范围",
        "imageCompressScope.selected": "当前选中图片",
        "imageCompressScope.all": "当前目录全部图片",
    ...
    en: {
        ...
        "deleteMode.single": "Delete single page",
        "deleteMode.range": "Delete first / last N pages",
        "deleteMode.range-se": "Delete page range",
        "deleteCount.label": "Page / Count",
        "deleteStart.label": "Start Page",
        "deleteEnd.label": "End Page",
        "deleteBack.label": "Count from end",
        "deleteBtn": "Delete",
        "panel-extract.h3": "Page Extract",
        "extractMode.label": "Extract Mode",
        "extractMode.png": "Single page → PNG",
        "extractMode.pdf": "Page range → PDF",
        "extractDpi.label": "DPI Mode",
        "extractDpi.bw": "B&W (600 DPI)",
        "extractDpi.color": "Color (300 DPI)",
        ...
        "zipDpi.bw": "B&W (600 DPI)",
        "zipDpi.color": "Color (300 DPI)",
        "zip2pdfBtn": "Convert",
        "panel-clean.h3": "Clean",
        "cleanType.label": "Clean Type",
        "cleanType.x_backup": "x_backup (resize backups)",
        "cleanType.y_backup": "y_backup (page op backups)",
        "cleanType.zip": "ZIP files",
        "cleanType.all": "Clean all",
        "cleanBtn": "Clean",
        ...
        "imageMergeMode.grid": "Grid (3×3)",
        "imageMergeMode.vertical": "Vertical strip",
        "imageMergeMode.horizontal": "Horizontal strip",
        ...
        "imageConvertScope.selected": "Selected image",
        "imageConvertScope.all": "All images in directory",
        ...
        "imageCompressScope.selected": "Selected image",
        "imageCompressScope.all": "All images in directory",
